...
# A MÁGICA ESTÁ AQUI: Lê a variável de ambiente para saber quem está executando
...
@track_provenance_experiment(
    ...
    prospective_params={
        ...
        "runner": runner_mode,  # coloquei dinâmico agora par adicionar as flags python ou noWorkflow para teste
    },
)
